...
save_seq(tracked_mask, '/Users/jefft/Downloads/PCNA_groundTruth/001_RES', 'mask')
...
t = load_trks('/Users/jefft/Desktop/001.trk')
lin = t['lineages']
mask = t['y']
txt = lineage_dic2txt(lin)
# save
txt.to_csv('/Users/jefft/Desktop/man_track.txt', index=0, sep=' ', header=False)
save_seq(mask, '/Users/jefft/Downloads/PCNA_groundTruth/001_GT/SEG', 'man_seg')
save_seq(mask, '/Users/jefft/Downloads/PCNA_groundTruth/001_GT/TRA', 'man_track')
